/*	@(#)f_errno.h 1.1 94/10/31 SMI; from UCB 1.5 */
/*
 *
...
#define F_ERTOOMANY	124	/* too many files open - no free descriptors */
#define F_ERNOTOPEN	125	/* attempted operation on unit thats not open */
