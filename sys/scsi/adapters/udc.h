/* @(#)udc.h 1.1 94/10/31 SMI */
/*
 * Copyright (c) 1989 by Sun Microsystems, Inc.
 */

#ifndef	_scsi_adapters_udc_h
#define	_scsi_adapters_udc_h

/*
 * AMD 9516 UDC (Universal DMA Controller) Registers.
 *
 * Used for the Sun3/50 and Sun3/60 SCSI interfaces only.
 */
...
#define	UDC_SR_NCRP		0x0200	/* second interrupt pending */
