/*	@(#)param.h 1.1 94/10/31 SMI; from UCB 4.35 83/06/10	*/
...
#ifdef SUNDBE
#define NOFILE  2048            /* DBE max open files per process */
#define NOFILE2 256             /* SunOS4.1 max open files per process */
#else
